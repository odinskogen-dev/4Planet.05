...
const currentState: Record<string, string> = {
  ...
  "4planet/e4rth/species": "SPECIES is active Gold work. An accepted internal shared-context Jaguar baseline exists with a verified immutable preview. The newer PR #79 premium Jaguar + Orca transfer line remains draft and must pass exact-head convergence before any newer Gold or production claim.",
  ...
  "4planet/tree-of-life": "TREE OF LIFE is an isolated interactive architecture prototype over the same 4PLANET system. It explains how intelligence, Missions, actors, solutions, capital, Impact and culture connect without becoming another product or truth store.",
  ...
  "4planet/product/jaguar-journey": "JAGUAR JOURNEY has an accepted shared-context baseline, while the newer premium Jaguar + Orca transfer line continues on PR #79. The newer head remains draft until exact-head convergence closes; production is unchanged.",
  ...
  "4planet/economy": "ECONOMY_ is a canonical shared Project Home with a DEMO / NOT LIVE v0.1 concept. No bank/accounting adapter is connected, and the previously projected GitHub URL is currently broken, so LABS withholds it instead of sending the Founder to a 404.",
  ...
  "4planet/labs-system": "LABS remains an open draft development surface and read-only BRAIN projection. The V6 pass is strengthening every Project Detail, refreshing current BRAIN/GitHub state and removing stale or broken Founder-facing links without changing the visual system.",
  "4planet/sonic": "SONIC is a new bounded shared Project Home. The rights-aware audio/data contract is the next build; no coded SONIC primitive, creator grant or verified public Sonic prototype is claimed yet.",
  "4planet/labs-system/creator-engine": "CREATOR ENGINE / CRE4TORS_ v0.3 is exact-head technically verified and Founder-visible on an immutable preview. Dedicated cre4tors.com binding and real creator workflow/economic proof remain open; all demo economy/time/opportunity values remain non-live.",
};
