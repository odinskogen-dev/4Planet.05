...
import { AnalyticsPreferences } from "@/analytics/AnalyticsConsent";
...
const SECTIONS: [string, React.ReactNode][] = [
  ...
  ["Analytics", <><p style={{ margin: 0 }}>4Planet may use Cloudflare Web Analytics for aggregate traffic and real-user performance measurement. Cloudflare states that its Web Analytics service does not collect or use visitors’ personal data.</p><p style={{ margin: "12px 0 0" }}>Optional Google Analytics, when configured, stays off unless you explicitly allow it. Advertising storage, ad user data and ad personalisation are disabled in 4Planet’s analytics configuration. You can change that choice below.</p><AnalyticsPreferences /></>],
    ...
    <PublicShell>
      <Section pad="clamp(56px,8vw,110px)">
        <Reveal>
          ...
          <p style={{ fontSize: "clamp(16px,1.3vw,19px)", color: T.ink, opacity: .7, marginTop: 20, maxWidth: 640, lineHeight: 1.6 }}>A short, plain-language note covering interest registration and optional site analytics.</p>
        </Reveal>
