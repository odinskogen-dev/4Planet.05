 ...
 *
 * It uses the shared Blue Marble whole-Earth still as a fast, reliable, on-brand
 * hero and hands off into the full live ATLAS product. A live in-page globe embed
 * is intended, but mounting the full ATLAS engine inline needs a dedicated
 * chromeless "attract" mode in the map engine (an auditable change to World) so it
 * doesn't bring its controls or disturb page layout — deferred rather than shipped
 * half-done. The hero already reads as the living planet and leads straight in.
 */
