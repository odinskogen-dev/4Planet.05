    ...
    <main className="c4-home">
      ...
      <section className="c4-system" id="system">
        ...
        <div className="c4-system-grid">
          {SYSTEMS.map(([index, title, body]) => <article key={title}><small>{index}</small><h3>{title}</h3><p>{body}</p></article>)}
        </div>
      </section>

      <section className="c4-safety">
        <div className="c4-safety-title"><div className="c4-section-label">SAFETY FLOOR</div><h2>Useful enough to lean on.<br/>Safe enough to leave.</h2></div>
      ...
      <section className="c4-force" id="force">
        <div className="c4-force-head"><div className="c4-section-label">CREATIVES AS A FORCE FOR NATURE</div><h2>Your abilities can meet<br/>real planetary needs.</h2><p>4PLANET can become the first differentiated demand layer: mission-linked creative work with explicit value, rights and choice. The examples below are prototype fixtures only.</p></div>
