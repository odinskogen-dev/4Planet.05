    ...
    <main className="c4-home">
      ...
      <header className="c4-nav">
        ...
        <nav aria-label="CRE4TORS prototype navigation">
          <a href="#system">SYSTEM</a><a href="#force">FOR NATURE</a><Link to="/labs/creator">OPEN ENGINE</Link>
        </nav>
      </header>
      <section className="c4-hero">
        ...
        <div className="c4-hero-bottom">
          ...
          <div className="c4-actions"><Link className="c4-button c4-button-primary" to="/labs/creator">ENTER CREATOR ENGINE <span>↗</span></Link><Link className="c4-button" to="/labs/creator/capacity">HUMAN CAPACITY <span>→</span></Link></div>
        </div>
