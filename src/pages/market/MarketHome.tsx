    ...
    <main className="market-page">
      ...
      <section className="market-hero">
        ...
        <div className="market-hero__bottom">
          <p>Six photographs enter 4PLANET MARKET as the first real creator catalogue. The works and image assets are stored directly with 4PLANET MARKET. Pricing, editions, production and checkout remain deliberately closed until those contracts are ready.</p>
      ...
      <section className="market-creator" id="creator">
        ...
        <span className="market-creator__archive">CREATOR ARCHIVE · LOCAL MARKET COPY</span>
      </section>
      ...
      <section className="market-truth">
        ...
        <p>These six works are published as test catalogue products under Odin Oddekalv. Their web assets are hosted by 4PLANET MARKET. No price, edition size, paper, fulfilment provider, checkout, sale, payout or ecological outcome is represented as active.</p>
      </section>
      ...
      <section className="market-product-detail">
        ...
        <div className="market-product-detail__copy">
          ...
          <div className="market-product-detail__truth">
            ...
            <p>The work is real and creator-authorised for this Market test. The image asset is stored directly with 4PLANET MARKET. Production, commercial terms and checkout are not active.</p>
          </div>
        </div>
      </section>
    </main>
