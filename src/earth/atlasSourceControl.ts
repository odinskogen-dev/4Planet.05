...
export const ATLAS_SOURCE_CONTROL: Record<string, AtlasSourceControlRecord> = {
  ...
  "global-fishing-watch": {
    ...
    value: "Vessel/apparent fishing activity data only where a separate compatible commercial route is evidenced",
    stage: "RIGHTS_GATED",
    endpoint: "PENDING",
    ...
    failureMeaning: "Rights/auth/source failure is unavailable, never no vessels/no fishing.",
    limitation: "Current public/API terms do not clear commercial 4PLANET use. Apparent fishing effort is not catch, illegality or ecological impact.",
    checkedAt: "2026-09-02",
    evidenceRefs: ["PR#72 adapter seam", "Issue#144", "4PLANET Source & Rights Clearance v1.0 — 2026-09-02"],
  },
  "protected-planet": {
    id: "protected-planet",
