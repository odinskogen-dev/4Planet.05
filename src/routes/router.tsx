...
export function AppRoutes(){return <Routes>
 ...
 <Route path="/oce4n" element={<Navigate to="/domains/oce4n" replace/>}/><Route path="/e4rth" element={<Navigate to="/domains/e4rth" replace/>}/>
 ...
 <Route path="/magazine" element={toHome}/><Route path="/system" element={toHome}/>
