...
const OrcaLightLens = lazy(() => import("@/pages/integrated/OrcaLightLens"));
...
export function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/species/orca/light-lens" element={<Suspense fallback={WorldFallback}><OrcaLightLens /></Suspense>} />
