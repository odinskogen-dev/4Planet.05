...
const toPartners = <Navigate to="/partners" replace />;
const toAbout = <Navigate to="/about" replace />;
const toHome = <Navigate to="/" replace />;
const toSpecies = <Navigate to="/species" replace />;
const toOrca = <Navigate to="/species/orca" replace />;
const toAtlas = <Navigate to="/atlas" replace />;
const toSapien = <Navigate to="/domains/s4piens" replace />;
const toFood = <Navigate to="/missions/food" replace />;
...
export function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/species/lab" element={toSpecies} />
      <Route path="/species/orca/lume" element={toOrca} />
      <Route path="/species/:slug" element={<SpeciesRoute curatedElement={<SpeciesProfilePage />} />} />
      <Route path="/lens" element={toAtlas} />
      <Route path="/food/lens" element={toFood} />
      <Route path="/s4piens/food/lens" element={toFood} />
      <Route path="/4sapien" element={toSapien} />
      <Route path="/4sapien/*" element={toSapien} />
      <Route path="/food/pick" element={toFood} />
      <Route path="/impact" element={<ImpactPublicHome />} />
      <Route path="/impact/lab" element={toImpact} />
      <Route path="/impact/lab/*" element={toImpact} />
      <Route path="/impact/test/*" element={toImpact} />
      <Route path="/impact/record/*" element={toImpact} />
      ...
      <Route path="/actors" element={toPartners} />
      <Route path="/actors/*" element={toPartners} />
      <Route path="/get-involved" element={toJoin} />
      ...
      <Route path="/culture/film" element={<Navigate to="/missions/4film" replace />} />
      <Route path="/culture/play" element={<Navigate to="/missions/4play" replace />} />
