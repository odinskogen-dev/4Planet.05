...
export const EMODNET_SEABED_HABITATS: SandboxRasterDescriptor = {
  ...
  authority: "European Marine Observation and Data Network (EModnet)",
  product: "EUSeaMap 2025 · EUNIS 2019 habitat classification · 800 m simplified WMS product",
  ...
  limitation:
    "This is the current EUSeaMap 2025 EUNIS 2019 800 m simplified WMS product selected because a bounded broad-Europe contract request returned a substantial provider-styled raster while the former 2023 group is no longer accepted by the current service and the tested 2025 cached WMTS samples were transparent. It is a predictive habitat classification, not direct field observation or current ecological condition. Browser-visible desktop/mobile proof is still required before this exact product is MAP_GREEN.",
  checkedAt: "2026-08-19",
  opacity: 0.72,
};
