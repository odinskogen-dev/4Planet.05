...
export const EMODNET_SEABED_HABITATS: SandboxRasterDescriptor = {
  ...
  authority: "European Marine Observation and Data Network (EModnet)",
  product: "EUSeaMap 2023 · EUNIS 2019 habitat classification · scale-adaptive WMS group",
  ...
  limitation:
    "This is the provider's scale-adaptive EUSeaMap 2023 EUNIS 2019 WMS group, retained as the current ATLAS lab default because it has already passed broad-Europe desktop and 390 px visual QA. It is a predictive habitat classification, not direct field observation or current ecological condition. Newer 2025 WMTS/WMS products remain candidates until their map coverage and tile-scale behaviour pass the same visual gate.",
  checkedAt: "2026-08-19",
  opacity: 0.72,
};
