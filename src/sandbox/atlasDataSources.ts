...
export const EMODNET_SEABED_HABITATS: SandboxRasterDescriptor = {
  ...
  authority: "European Marine Observation and Data Network (EMOdnet)",
  product: "EUSeaMap 2025 · MSFD benthic broad habitat types · 800 m simplified WMS product",
  ...
  limitation:
    "This is a broad-scale predictive EUSeaMap 2025 MSFD habitat-classification product. The sandbox deliberately restored this 800 m WMS product because the same bounded MapLibre-shaped request produced real non-transparent provider-styled pixels while the newer tested EUNIS 800 m request timed out and several finer candidates were fully transparent. It is not direct field observation, current ecological condition, absence evidence or local habitat confirmation. Exact deployed desktop/mobile proof is still required before current-lineage MAP_GREEN.",
  checkedAt: "2026-08-19",
  opacity: 0.72,
};
