...
export const EMODNET_SEABED_HABITATS: SandboxRasterDescriptor = {
  ...
  authority: "European Marine Observation and Data Network (EMODnet)",
  product: "EUSeaMap · current EUNIS 2019 classification group · scale-adaptive 2025 source layers",
  layer: "eusm_eunis2019_group",
  style: "default-style-eusm_eunis2019_group",
  docs: "https://emodnet.ec.europa.eu/en/seabed-habitats",
  service: "https://ows.emodnet-seabedhabitats.eu/geoserver/emodnet_view/wms",
  attribution: "EModnet Seabed Habitats / EUSeaMap · CC BY 4.0",
  limitation:
    "This is the provider's scale-adaptive EUSeaMap EUNIS 2019 WMS group, whose capabilities state that it contains the current EUSeaMap version with 200 m, 400 m and 800 m simplification levels for fast viewing at all scales. The current child layers are EUSeaMap 2025 products. It is a broad-scale predictive habitat map, not direct field observation or current ecological condition. Internal simplification child layers are deliberately not used as the public ATLAS entry layer.",
  checkedAt: "2026-08-19",
  opacity: 0.72,
};
