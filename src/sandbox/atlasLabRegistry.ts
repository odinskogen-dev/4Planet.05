...
export type AtlasLabTemporal = {
  kind: "STATIC" | "SNAPSHOT" | "TIME_SERIES" | "NEAR_REAL_TIME";
  selected?: string;
...
export const ATLAS_LAB_SCENES = [
  {
    ...
    purpose: "Read physical ocean form before adding habitat or human pressure.",
  },
  {
    id: "OCEAN_HABITAT",
    label: "OCEAN + HABITAT",
  ...
  },
  {
    ...
    purpose: "Place historical vessel-density pressure context over the ocean foundation stack.",
  },
] as const;
