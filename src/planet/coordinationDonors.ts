...
export const COORDINATION_DONORS: CoordinationDonor[] = [
  ...
  },
  {
    ...
    doNotAdoptBlindly: ["old maturity labels", "old UI", "old ordering where it conflicts with current Problem-first PCI-01"],
    state: "SELECTIVE_ADOPTION",
    rationale: "GitHub PR #82 currently verifies head 946041d04beaf5db86ad317f854b7986d731b694. Semantics are adopted selectively; current PCI-01 remains the coordination contract candidate.",
  },
  {
...
export const DONOR_RECOVERY_RULES = [
  ...
  "A conflicting remembered donor head fails closed to REVERIFY until GitHub authority resolves it.",
