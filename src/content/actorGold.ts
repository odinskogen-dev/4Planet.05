...
export const ACTOR_GOLD_PROFILES: ActorGoldProfile[] = [
  {
    ...
    visual: { primary: "ATLAS_PLACE", fallbacks: ["IDENTITY_FIELD", "RELATIONSHIP_GRAPH", "SOURCE_DATA"], label: "Bay of Biscay survey-intelligence field", truthBoundary: "Illustrative monitoring context; not a migration track, live location, abundance surface or measured outcome.", documentaryRightsState: "NOT_REQUIRED" },
  ...
  },
  {
    ...
    evidence: [{ label: "Identity resolution", state: "OPEN", note: "P17-A296 is the research-view candidate. P17-A399 appears to duplicate the same institution in another legacy view and must be reconciled before scale." }],
    ...
    sourceAuthority: "4PLANET Global Actor Master / P17-A296; identity-merge review open for P17-A399", correctionsPath: "/magazine/corrections",
  },
  {
    ...
    evidence: [{ label: "KPA 2027 consultation", state: "SOURCE_READY", note: "Official Bergen kommune source is the decision authority." }],
    ...
    intelligence: { researchIds: ["RES-BGO-PROCLIMATE-01", "RES-BGO-KPA-PARKING-01"], problemIds: ["PROBLEM-BGO-LAND-CLIMATE", "PROBLEM-BGO-MOBILITY-CLIMATE"], decisionIds: ["DEC-BGO-KPA-2027"], solutionIds: [], capitalIds: [] },
  ...
  },
  {
    ...
    evidence: [{ label: "Canonical capital identity", state: "SOURCE_READY", note: "Resolved to P17-A1787. Opportunity records remain separate objects." }],
    fieldFeed: [], magazineCoverage: [], actions: [{ label: "See coordination proof", path: "/places/norway#capital", state: "OPEN" }],
...
export const ACTOR_GOLD_RELEASE_RULES = ["One shared /actors/:slug template", "Canonical identity remains in Actor Master / BRAIN", "Profile existence never implies partnership, endorsement or capability", "A capital actor is not a capital opportunity", "A government actor is not a decision", "A research institution is not a scientific claim", "Field/update feed renders only real released items", "Human editorial/product judgement remains a GOLD release gate"] as const;
