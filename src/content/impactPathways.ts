...
export const IMPACT_PATHWAYS: ImpactPathway[] = [
  ...
  { slug: "ocean-waste", code: "01_ CLE4N_", missionName: "CLE4N_", unitLabel: "1 KG OCEAN WASTE", actionLabel: "CLEAN THE OCEAN",
    description: "Designed to support one measurable kilogram of marine waste recovery through an approved delivery pathway. This is the ocean-waste pathway of the CLE4N_ Mission; the former PL4STIC_ Mission name is retired.",
