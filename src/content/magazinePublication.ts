export const MAGAZINE_PUBLICATION_STATE = {
  release: "PRE_PUBLICATION_GOLD_CANDIDATE",
  publicSince: null,
  publisher: "4PLANET MAGAZINE",
  editorialDesk: "4PLANET Editorial Desk",
  promise:
    "Stories that earn the reader's time: human-first, source-aware, visually literate and explicit about what the evidence can and cannot support.",
} as const;
...
export const MAGAZINE_PUBLICATION_PIPELINE = [
  ...
  "VISUALS",
  "QA",
  "FOUNDER JUDGE / RELEASE WHEN REQUIRED",
  "PUBLISH",
  "DISTRIBUTE",
  "LEARN",
] as const;
...
export const MAGAZINE_EDITORIAL_FORMS = [
  {
    id: "FEATURE",
    label: "Feature",
    job: "A deeply edited narrative or systems story worth sustained attention.",
  },
  {
    id: "FIELD",
    label: "From the Field",
    job: "People, methods and places where observation or action actually happens.",
  },
  {
    id: "EXPLAINER",
    label: "Explainer",
    job: "Make a difficult living-system question legible without flattening it.",
  },
  {
    id: "WHAT_WORKS",
    label: "What Works",
    job: "Interrogate a proposed solution, including mechanism, evidence, trade-offs and limits.",
  },
  {
    id: "LIVING_WORLD",
    label: "The Living World",
    job: "Enter through a species or ecosystem and reveal the system around it.",
  },
  {
    id: "PLANET_SIGNAL",
    label: "Planet Signal",
    job: "One timely source, one useful observation, one reason it matters and one explicit boundary.",
  },
  {
    id: "VISUAL_ESSAY",
    label: "Visual Essay",
    job: "Let images carry part of the argument while captions, context and rights remain attached.",
  },
  {
    id: "INTERVIEW_PROFILE",
    label: "Interview / Profile",
    job: "Reserved for real original reporting with a named person; never fabricated from secondary material.",
  },
] as const;
...
export const MAGAZINE_RELEASE_STANDARD = [
  ...
  "Canonical URL, metadata, internal links, alt text and source links are present before release where the format requires them.",
  "The story passes desktop, mobile, keyboard and reduced-motion checks before publication.",
  "No PRE_PUBLICATION object is described as public merely because code or a preview exists.",
] as const;
...
export const MAGAZINE_VOICE = [
  ...
  "Reader value is the final editorial gate: every published object must teach, reveal, reframe, orient or help someone see what to inspect next.",
] as const;
