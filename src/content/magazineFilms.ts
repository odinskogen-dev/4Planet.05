...
const published: FilmRecord[] = [
  ...
  publishedFilm({
    ...
    watchUrl: "https://www.youtube.com/watch?v=XdNJ0JAwT7I", trailerId: "XdNJ0JAwT7I", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "Wild salmon, aquaculture, river systems and the difference between managing nature and keeping it alive.", availabilityNote: "Full film is available free through Patagonia’s official release."
  }),
  publishedFilm({
    ...
    watchUrl: "https://www.youtube.com/watch?v=laTIbNVDQN8", trailerId: "laTIbNVDQN8", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "Energy infrastructure, rivers, restoration and what happens when yesterday’s solution becomes today’s constraint.", availabilityNote: "Full film is available free through Patagonia’s official release."
  }),
  publishedFilm({
  ...
  publishedFilm({
    ...
    watchUrl: "https://www.youtube.com/watch?v=_QNYQfdVEOk", trailerId: "_QNYQfdVEOk", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "Climate change experienced as place, home, infrastructure and community rather than an abstract graph.", availabilityNote: "Official Patagonia film route; current availability is linked."
  }),
  publishedFilm({
    ...
    watchUrl: "https://www.youtube.com/watch?v=BrmKoU2Oe5I", trailerId: "BrmKoU2Oe5I", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "The psychology and communication infrastructure behind collective climate action.", availabilityNote: "Official Patagonia film route; current availability is linked."
  }),
  publishedFilm({
    ...
    watchUrl: "https://www.youtube.com/watch?v=MHdE2YCRjck", trailerId: "MHdE2YCRjck", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "Ancient forest, cultural heritage and conservation conflict concentrated in one place.", availabilityNote: "Official Patagonia film route; current availability is linked."
  }),
  publishedFilm({
    slug: "treeline", title: "Treeline", year: 2019, focus: "FORESTS / CLIMATE / CULTURE", topics: ["LAND_WILDLIFE", "CLIMATE", "PEOPLE"], accent: "violet", director: "Patagonia Films", runtime: "40 MIN", access: "FULL_FREE", platform: "PATAGONIA FILMS",
    description: "Skiers, snowboarders, scientists and cultural practitioners travel through ancient forests in Japan, British Columbia and Nevada to understand the lives of trees.", credit: "A Patagonia Films production.",
    watchUrl: "https://www.youtube.com/watch?v=YCEaYInJbos", trailerId: "YCEaYInJbos", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "A patient, cinematic route into forests as living systems rather than scenery.", availabilityNote: "Official Patagonia film route; current availability is linked."
  }),
  publishedFilm({
    ...
    watchUrl: "https://www.youtube.com/watch?v=dUfcDGZIruI", trailerId: "dUfcDGZIruI", sourceUrl: "https://www.patagonia.com/films/jalpi/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "A seven-minute restoration story where place, marine habitat and local stewardship meet.", availabilityNote: "Full film is linked from Patagonia’s official film page."
  }),
  publishedFilm({
    ...
    watchUrl: "https://www.youtube.com/watch?v=R48JeOPv1R4", trailerId: "R48JeOPv1R4", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "Ocean conservation seen through Indigenous stewardship, place and industrial pressure.", availabilityNote: "Official Patagonia film route; current availability is linked."
  }),
  publishedFilm({
    slug: "undammed", title: "Undammed", year: 2024, focus: "RIVERS / INDIGENOUS STEWARDSHIP / RESTORATION", topics: ["LAND_WILDLIFE", "PEOPLE", "SOLUTIONS"], accent: "blue", director: "Patagonia Films", runtime: "17 MIN", access: "FULL_FREE", platform: "PATAGONIA FILMS",
    description: "A Yurok-led story of Klamath River dam removal, river restoration and the long campaign to bring salmon back to a living watershed.", credit: "A Patagonia Films production.",
    watchUrl: "https://www.youtube.com/watch?v=PoZKMtqK8u4", trailerId: "PoZKMtqK8u4", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "Infrastructure decisions connected directly to culture, fish and an entire river system.", availabilityNote: "Official Patagonia film route; current availability is linked."
  }),
  publishedFilm({
    ...
    watchUrl: "https://www.youtube.com/watch?v=rfLBmMK1SAg", trailerId: "rfLBmMK1SAg", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "Aquaculture, wild salmon and community agency where food production meets ecosystem risk.", availabilityNote: "Full film is available through Patagonia’s official release."
  }),
  publishedFilm({
    slug: "range-rider", title: "Range Rider", year: 2023, focus: "WOLVES / RANCHING / COEXISTENCE", topics: ["LAND_WILDLIFE", "PEOPLE", "SOLUTIONS"], accent: "violet", director: "Colin Arisman", runtime: "30 MIN", access: "FULL_FREE", platform: "PATAGONIA FILMS",
    description: "A range rider in northeast Washington uses non-lethal methods to reduce conflict between wolves, livestock and ranching communities.", credit: "Directed by Colin Arisman.",
    watchUrl: "https://www.youtube.com/watch?v=KzG6kiMXO98", trailerId: "KzG6kiMXO98", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "Coexistence designed in the field: predators, livelihoods, incentives and practical adaptation.", availabilityNote: "Official Patagonia film route; current availability is linked."
  }),
  publishedFilm({
    slug: "the-shitthropocene", title: "The Shitthropocene", year: 2024, focus: "CONSUMPTION / MATERIALS / CULTURE", topics: ["CLIMATE", "SOLUTIONS", "PEOPLE"], accent: "pink", director: "Patagonia Films", runtime: "46 MIN", access: "FULL_FREE", platform: "PATAGONIA FILMS",
    description: "A provocative look at overproduction, consumption and the systems that keep filling everyday life with more cheap products than people or the planet need.", credit: "A Patagonia Films production.",
    watchUrl: "https://www.youtube.com/watch?v=4TsndZxysts", trailerId: "4TsndZxysts", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "Culture, materials and consumption as environmental systems rather than lifestyle trivia.", availabilityNote: "Official Patagonia film route; current availability is linked."
  }),
  publishedFilm({
    ...
    watchUrl: "https://www.youtube.com/watch?v=4LHMZmtpZdg", trailerId: "4LHMZmtpZdg", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "A short, concrete example of waste, materials, traceability and circular design.", availabilityNote: "Official Patagonia film route; current availability is linked."
  }),
  publishedFilm({
    slug: "sea-country-malu-lag", title: "Sea Country / Malu Lag", year: 2025, focus: "ISLANDS / CLIMATE / CULTURE", topics: ["OCEAN", "CLIMATE", "PEOPLE"], accent: "violet", director: "Patagonia Films", runtime: "14 MIN", access: "FULL_FREE", platform: "PATAGONIA FILMS",
    description: "A remote island community off northern Australia carries its relationship with Sea Country and its climate concerns into wider political arenas.", credit: "A Patagonia Films production.",
    watchUrl: "https://www.youtube.com/watch?v=1S8hXIht4PU", trailerId: "1S8hXIht4PU", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "Climate change as culture, place and sovereignty — not merely temperature.", availabilityNote: "Official Patagonia film route; current availability is linked."
  }),
  publishedFilm({
    slug: "home-grown", title: "Home, Grown", year: 2023, focus: "BUILDINGS / LOW-CARBON MATERIALS", topics: ["CLIMATE", "SOLUTIONS", "PEOPLE"], accent: "green", director: "Patagonia Films", runtime: "12 MIN", access: "FULL_FREE", platform: "PATAGONIA FILMS",
    description: "Builders explore straw-bale construction and natural materials as a route toward lower-carbon buildings rooted in local resources.", credit: "A Patagonia Films production.",
    watchUrl: "https://www.youtube.com/watch?v=lHx9nDOaXIQ", trailerId: "lHx9nDOaXIQ", sourceUrl: "https://www.patagonia.com/stories/culture/workwear/home-grown/video-141549.html", sourceLabel: "PATAGONIA / OFFICIAL", selectionNote: "A compact materials-and-buildings solution with carbon, craft and place in the same frame.", availabilityNote: "Official Patagonia film route; current availability is linked."
  }),
  publishedFilm({
    ...
    watchUrl: "https://www.youtube.com/watch?v=z5-NvY3Hj0k", trailerId: "z5-NvY3Hj0k", sourceUrl: "https://eu.patagonia.com/ee/en/films/fire-lines/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "Fire as a living-system management problem where ecology, culture and policy meet.", availabilityNote: "Official Patagonia film route; current availability is linked."
  }),
  publishedFilm({
    ...
    watchUrl: "https://www.youtube.com/watch?v=kjcR-pAjBiw", trailerId: "kjcR-pAjBiw", sourceUrl: "https://www.patagonia.com/stories/planet/activism/this-is-not-a-drill/video-174878.html", sourceLabel: "PATAGONIA / OFFICIAL", selectionNote: "The energy system viewed from the communities carrying its direct costs.", availabilityNote: "Official Patagonia full-film route; current availability is linked."
  }),
  publishedFilm({
    slug: "the-last-observers", title: "The Last Observers", year: 2024, focus: "CLIMATE / WEATHER / OBSERVATION", topics: ["CLIMATE", "PEOPLE"], accent: "violet", director: "Maja K. Mikkelsen", runtime: "25 MIN", access: "FULL_FREE", platform: "PATAGONIA FILMS",
    description: "Long-term weather observers Karin and Lennart document changing conditions while holding onto a patient practice of looking closely at nature.", credit: "Directed by Maja K. Mikkelsen.",
    watchUrl: "https://www.youtube.com/watch?v=nWbESISCdgA", trailerId: "nWbESISCdgA", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "Observation itself is infrastructure: years of careful measurement turn change into evidence.", availabilityNote: "Official Patagonia film route; current availability is linked."
  }),
  publishedFilm({
    ...
    watchUrl: "https://www.youtube.com/watch?v=ORse4_PburA", trailerId: "ORse4_PburA", sourceUrl: "https://www.patagonia.com/films/all/", sourceLabel: "PATAGONIA FILMS / OFFICIAL", selectionNote: "Food, materials, livelihoods and ocean health are inseparable on a working waterfront.", availabilityNote: "Official Patagonia film route; current availability is linked."
  }),
  publishedFilm({
