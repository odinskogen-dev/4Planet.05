...
export const PRINTS: PrintWork[] = [
  {
    ...
    rights: "Artwork © the artist; 4PLANET holds a non-exclusive print licence for this edition only.",
  ...
  },
  {
    ...
    rights: "Artwork © the artist; 4PLANET print licence for this edition only.",
