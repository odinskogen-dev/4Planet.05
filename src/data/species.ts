...
export const SPECIES_PROFILES: SpeciesProfile[] = [
  ...
  },
  {
    ...
    solution: { id: "solution:4p:protected-restoration", label: "Protection and restoration", status: "SOURCE_REVIEW_PENDING" },
    context: "Working execution profile. The largest cat in the Western Hemisphere; species-level context is kept separate from local population and occurrence evidence.",
    group: "Land mammals",
    intro: "The largest cat in the Western Hemisphere, an apex carnivore found from Mexico to Argentina. Local population status and ecological condition require place-specific evidence.",
    habitat: "Across parts of Mexico, Central America and South America to northern Argentina; connected habitat and prey are central to range-wide conservation.",
    descriptorSource: { source: "Panthera Jaguar Program", sourceUrl: "https://panthera.org/pantheras-jaguar-program", checkedAt: "2026-08-18", note: "Range-wide species and conservation context. This does not establish local presence, population status, corridor function or ecological condition at any occurrence point." },
    journey: "amazonia",
    missionSlug: "am4zonia",
    publicClaims: [
      { state: "KNOWN", text: "Panthera describes the jaguar as the largest cat in the Western Hemisphere and its range as extending from Mexico to Argentina.", source: "Panthera — Jaguar", sourceUrl: "https://www.panthera.org/cat/jaguar", checkedAt: "2026-08-18", limitation: "Species-level range context. It does not establish current presence, abundance or population status at a particular mapped point." },
      { state: "KNOWN", text: "Habitat loss and fragmentation, conflict with people and retaliatory killing, and overhunting of jaguar prey are documented threat categories.", source: "Panthera — Jaguar", sourceUrl: "https://www.panthera.org/cat/jaguar", checkedAt: "2026-08-18", limitation: "Threat intensity and mechanisms vary by place; this is not a local diagnosis." },
      { state: "INTERPRETED", text: "Connectivity is a useful lens for understanding jaguar conservation, but an occurrence record alone cannot show whether a corridor is functional or a population is connected.", source: "Panthera Jaguar Program + 4PLANET interpretation", sourceUrl: "https://panthera.org/pantheras-jaguar-program", checkedAt: "2026-08-18", limitation: "The connectivity interpretation requires landscape-specific evidence before any local conclusion." },
    ],
  },
  {
