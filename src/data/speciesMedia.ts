...
export const SPECIES_MEDIA: Record<string, MediaRecord> = {
  orca: {
    ...
    licence: "Founder-supplied provenance only — no verified licence on record; ownership, commercial, crop, modification and public-web rights are NOT asserted", licenceUrl: "",
    attribution: "4PLANET — founder-supplied (provenance only)", checkedDate: "2026-08-11",
    cropAllowed: false, modificationAllowed: false, publicWebAllowed: false, commercialAllowed: false,
    supportedUse: "None asserted until a real licence record exists.",
    limitations: "Provenance only — until a licence is recorded, the profile renders the 4PLANET-owned illustration instead of this photo.",
    rightsStatus: "PENDING", assetBlocker: "Founder-supplied provenance only. To show this photo: record its real licence — either the founder's own copyright/written grant (© holder, terms, date) or swap to a public-domain/CC orca (e.g. NOAA Fisheries). Until then the profile uses the 4PLANET-owned illustration.",
  },
