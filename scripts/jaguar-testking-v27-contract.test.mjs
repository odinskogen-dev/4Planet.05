...
test('TEST KING Jaguar uses controlled Ear.Rodriguez indexed donor topology, physical jungle room, LUME room and all eight chapters',()=>{
  ...
  assert.match(html,/jaguar-ear-proxy-v25\.js/);assert.match(html,/jaguar-surface-recovery-v37\.js/);assert.match(html,/jaguar-gold-v33\.js/);assert.match(html,/jaguar-gold-v33\.css/);
