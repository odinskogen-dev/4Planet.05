...
test('TEST KING Jaguar 33 uses an actual Ear-derived triangle surface, physical jungle room, LUME room and all eight chapters',()=>{
  ...
  assert.match(html,/jaguar-surface-v33\.js/);assert.match(html,/jaguar-gold-v33\.js/);assert.match(html,/jaguar-gold-v33\.css/);
  ...
  assert.match(html,/PANTHERA ONCA/);assert.match(html,/ORIGINAL ANIMATED MASTER SECURED/);
});
