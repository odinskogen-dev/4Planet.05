-- v1.1 fail-closed SQL-null fix: bills without payment_state are SCHEDULED, not filtered by NULL boolean.
-- Historic v1 migration retained; this additive replacement is the canonical runtime.
...
begin
  ...
  return jsonb_build_object(
    ...
    'before_next_income',jsonb_build_object(
      ...
      'projected_without_income',case when v_status='KNOWN_RECORDED' and v_next_income is not null then
