...
# Add the isolated Finance world as a sibling route without touching the
# existing Ask Embla / Food root artifact.
subprocess.run([sys.executable, str(here / "apply_finance_route.py"), target], check=True)

print("4SAPIEN theme pipeline applied: Yellow 02 base + Light/Dark 01 + Finance route")
