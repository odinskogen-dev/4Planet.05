...
replace_once('input::placeholder{color:#000000;opacity:.58}','input::placeholder{color:currentColor;opacity:.58}','placeholder follows theme')
replace_once(':focus-visible{outline:2px solid #000000;',':focus-visible{outline:2px solid var(--4sapien-focus,#000000);','focus follows theme')
replace_once('background:"#FFFF00",backdropFilter:"blur(8px)"','background:T.paper,backdropFilter:"blur(8px)"','bottom nav follows theme')
...
for required in ['4SAPIEN LIGHT DARK 01','const THEMES={','localStorage.getItem("4sapien_theme")','localStorage.setItem("4sapien_theme",mode)','theme==="dark"?"light":"dark"','Bytt til mørk modus','Bytt til lys modus','paper:"#000000"','blue:"#FFFF00"','calm:"#111111"','background:T.paper,backdropFilter:"blur(8px)"']:
