...
export const onRequestPost = async (ctx: { request: Request; env: Env }): Promise<Response> => {
  ...
  // This endpoint establishes payment-event truth only. A payment event must not mutate
  // ecological Delivery, Evidence, Outcome or System Impact without the separate IMPACT state machine.
