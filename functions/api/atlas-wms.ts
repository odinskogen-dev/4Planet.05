...
const PROFILES: Record<string, Profile> = {
  ...
  "noaa-coral-dhw": {
    base: "https://coastwatch.pfeg.noaa.gov/erddap/wms/NOAA_DHW/request",
    mode: "NOAA_ERDDAP_CRS84",
    fixedLayer: "NOAA_DHW:CRW_DHW",
    maxAge: 3600,
  },
};

const TRANSPARENT_256_PNG = "";
