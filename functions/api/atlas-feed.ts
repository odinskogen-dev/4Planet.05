 ...
 *
 * Same-origin, allowlisted proxy for public JSON feeds that are useful to ATLAS
 * but can be unreliable when fetched directly from a browser due to CORS,
 * transient edge behaviour or provider headers. No arbitrary URL forwarding.
 */
