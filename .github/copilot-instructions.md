...
Every material return must include project/task identity, branch, exact commit SHA, PR/issue if applicable, changed files or visible change, tests/runtime evidence, limitations, exact status and next gate. Preserve failed approaches and their evidence when they teach a reusable lesson.
